...
const experiences: Experience[] = [
  {
    ...
    story:
      "It was my first time working with Arc XP Fusion, and I learned a lot about how media groups like USC Annenberg deploy websites.",
    impact:
      "Built a custom triple-column React layout block on Arc XP's Fusion platform with structured content feeds and theme-aware styling, and am an incoming Web Editor Team lead for Fall 2026.",
    stack:
