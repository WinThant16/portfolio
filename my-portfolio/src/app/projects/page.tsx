...
import { Github, ExternalLink, Calendar, Clock, Code, CodeXml, Cpu, Microscope, Database, Brain, Box } from "lucide-react";
      ...
      <div className="mx-auto w-full max-w-8xl px-4 sm:px-6 lg:px-8">
        ...
        <Tabs defaultValue="All" className="mt-10">
          <div className="w-full overflow-x-auto pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            <TabsList className="mx-auto flex w-max rounded-full bg-white/5 backdrop-blur border border-white/10 p-1 gap-1">
              {categories.map((c) => (
                <TabsTrigger key={c} value={c} 
                              aria-label={`${c} projects`}
