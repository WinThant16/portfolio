...
const items = [
  ...
  icon: Code,
  tone: "from-purple-500/15 to-fuchsia-500/15 border-purple-500/20",
 },
  {
    title: "Web Stack",
    desc: "Next.js · Node.js · React · TypeScript · Tailwind · HTML/CSS · shadcn/ui",
    icon: Code2,
    tone: "from-rose-400/15 to-fuchsia-600/15 border-rose-400/20",
  },
  {
    title: "Databases",
    desc: "Postgres · MySQL · MongoDB · NoSQL · SQLite",
    icon: Database,
    tone: "from-pink-500/15 to-purple-500/15 border-pink-500/20",
  },
  {
    title: "Infra & deploy",
  ...
  },
  {
    ...
    icon: Boxes,
    tone: "from-blue-500/15 to-cyan-500/15 border-blue-500/20",
  },
  {
